"""Standalone unit tests for password service functionality."""
...
class PasswordService:
    """Standalone password service for testing."""
...
class TestPasswordService:
    ...
    def test_validate_password_strength_no_special(self):
        ...
        assert result['is_valid'] is False
        assert any("Password must contain at least one special character" in error for error in result['errors'])
